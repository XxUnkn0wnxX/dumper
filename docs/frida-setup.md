...
[← Back to the Dumper README](../README.md) · [🧱 Python setup](setup.md) · [📱 Android setup](android-setup.md) · [🧪 Testing](testing.md)
...
`130` if its Ctrl+C fallback had to force-stop it.
